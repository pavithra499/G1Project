...
class OperatorFormatTables {
  ...
  /**
   * @return a copy of the set of all low-level opt operators
   *   the opt compiler understands
   */
  static public Set<String> getCopyOfOpcodeSet() {
  ...
  /**
   * initialize tables for IA32_FFREEP
   */
  static {
    String key = "IA32_FFREEP".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
    formats.put( key, "MIR_Nullary");
  ...
  /**
   * initialize tables for IA32_FNSTSW
   */
  static {
    String key = "IA32_FNSTSW".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
  ...
  /**
   * initialize tables for IA32_FSTSW
   */
  static {
    String key = "IA32_FSTSW".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
    formats.put( key, "MIR_Unary");
  ...
  /**
   * initialize tables for IA32_MOVSXDQ
   */
  static {
    String key = "IA32_MOVSXDQ".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
    formats.put( key, "MIR_Unary");
  ...
  /**
   * initialize tables for IA32_UD2
   */
  static {
    String key = "IA32_UD2".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
    formats.put( key, "MIR_Empty");
  ...
  /**
   * initialize tables for IA32_MOVAPD
   */
  static {
    String key = "IA32_MOVAPD".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
    formats.put( key, "MIR_Move");
  ...
  /**
   * initialize tables for IA32_MOVAPS
   */
  static {
    String key = "IA32_MOVAPS".substring(5);
    operators.add( key );
    int suffix = key.indexOf( "__" );
    if (suffix != -1) key = key.substring(0, suffix);
    formats.put( key, "MIR_Move");
