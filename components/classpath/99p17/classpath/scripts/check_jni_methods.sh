...
grep -h '^JNIEXPORT .* Java_' /home/csgrad/pnallamo/605/Test/Project605/components/classpath/99p17/classpath/include/*.h | \
...
find /home/csgrad/pnallamo/605/Test/Project605/components/classpath/99p17/classpath/native/jni -name \*.c | \
	xargs grep -h '^Java_' | \
...
find /home/csgrad/pnallamo/605/Test/Project605/components/classpath/99p17/classpath/native/jni -name \*.cpp | \
	xargs grep -h '^Java_' | \
        LC_ALL=C sed -e 's,^\(Java_[a-z_A-Z0-9]*\).*$,\1,' >> $TMPFILE2
find /home/csgrad/pnallamo/605/Test/Project605/components/classpath/99p17/classpath/native/jni -name \*.cpp | \
