...
public class Tutorial extends Plan {
   ...
   *
   */
  public static final ImmortalSpace tutorialSpace = new ImmortalSpace("default", VMRequest.discontiguous());
  public static final int TUTORIAL = tutorialSpace.getDescriptor();
  ...
  public int getPagesUsed() {
    return (tutorialSpace.reservedPages() + super.getPagesUsed());
  }
