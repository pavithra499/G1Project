 ...
 *
 */
public class AssemblerOpt extends AssemblerBase {

  /**
   * @param bcSize initial machine code buffer size.
   * @param print whether to dump generated machine code.
   * @param ir the IR object for the opt compilation.
   * @see org.jikesrvm.compilers.common.assembler.ia32.Assembler
   */
  ...
  private void doORPS(Instruction inst) {
    if (isXMM_Reg(MIR_BinaryAcc.getValue(inst))) {
      if (VM.VerifyAssertions && !isXMM_Reg(MIR_BinaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      emitORPS_Reg_Reg(
        ...
        if (isRegDisp(MIR_BinaryAcc.getValue(inst))) {
          ...
          if (isRegOff(MIR_BinaryAcc.getValue(inst))) {
            ...
            if (isRegIdx(MIR_BinaryAcc.getValue(inst))) {
              ...
              if (VM.VerifyAssertions && !isXMM_Reg(MIR_BinaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isRegInd(MIR_BinaryAcc.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              emitORPS_Reg_RegInd(
                getXMM_Reg(MIR_BinaryAcc.getResult(inst)),
  ...
  private void doCVTSD2SIQ(Instruction inst) {
    if (isXMM_Reg(MIR_Unary.getVal(inst))) {
      if (VM.VerifyAssertions && !isGPR_Reg(MIR_Unary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      if (VM.VerifyAssertions && !isQuad(inst)) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        ...
        if (isRegDisp(MIR_Unary.getVal(inst))) {
          ...
          if (isRegOff(MIR_Unary.getVal(inst))) {
            ...
            if (isRegIdx(MIR_Unary.getVal(inst))) {
              ...
              if (VM.VerifyAssertions && !isGPR_Reg(MIR_Unary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isRegInd(MIR_Unary.getVal(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isQuad(inst)) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doCVTSI2SS(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_Unary.getVal(inst))) {
        if (VM.VerifyAssertions && !isXMM_Reg(MIR_Unary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doFUCOMIP(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Compare.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Compare.getVal2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitFUCOMIP_Reg_Reg(
  ...
  private void doBSWAP(Instruction inst) {
    if (isQuad(inst)) {
      if (VM.VerifyAssertions && !isGPR_Reg(MIR_UnaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      emitBSWAP_Reg_Quad(
    ...
    if (isGPR_Reg(MIR_BinaryAcc.getResult(inst))) {
      if (isByte(inst)) {
        if (isImm(MIR_BinaryAcc.getValue(inst))) {
          if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_BinaryAcc.getResult(inst)).isValidAs8bitRegister());
          ...
          if (isGPR_Reg(MIR_BinaryAcc.getValue(inst))) {
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_BinaryAcc.getResult(inst)).isValidAs8bitRegister());
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_BinaryAcc.getValue(inst)).isValidAs8bitRegister());
      ...
      if (isImm(MIR_BinaryAcc.getValue(inst))) {
            ...
            if (isRegDisp(MIR_BinaryAcc.getResult(inst))) {
              ...
              if (isRegOff(MIR_BinaryAcc.getResult(inst))) {
                ...
                if (isRegIdx(MIR_BinaryAcc.getResult(inst))) {
                  ...
                  if (VM.VerifyAssertions && !isRegInd(MIR_BinaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        ...
        if (isByte(inst)) {
          if (isAbs(MIR_BinaryAcc.getResult(inst))) {
            if (VM.VerifyAssertions && !isGPR_Reg(MIR_BinaryAcc.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_BinaryAcc.getValue(inst)).isValidAs8bitRegister());
  ...
  private void doFIADD(Instruction inst) {
    if (isWord(inst)) {
      if (isAbs(MIR_BinaryAcc.getValue(inst))) {
        if (VM.VerifyAssertions && !isFPR_Reg(MIR_BinaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doFST(Instruction inst) {
    if (isQuad(inst)) {
      if (isAbs(MIR_Move.getResult(inst))) {
        if (VM.VerifyAssertions && !isFPR_Reg(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        ...
        if (isRegDisp(MIR_Move.getResult(inst))) {
          ...
          if (isRegOff(MIR_Move.getResult(inst))) {
            ...
            if (isRegIdx(MIR_Move.getResult(inst))) {
              ...
              if (VM.VerifyAssertions && !isRegInd(MIR_Move.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isFPR_Reg(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    ...
    if (isGPR_Reg(MIR_Compare.getVal1(inst))) {
      if (isByte(inst)) {
        if (isImm(MIR_Compare.getVal2(inst))) {
          if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Compare.getVal1(inst)).isValidAs8bitRegister());
          ...
          if (isGPR_Reg(MIR_Compare.getVal2(inst))) {
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Compare.getVal1(inst)).isValidAs8bitRegister());
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Compare.getVal2(inst)).isValidAs8bitRegister());
              ...
              if (isRegDisp(MIR_Compare.getVal2(inst))) {
                ...
                if (isRegOff(MIR_Compare.getVal2(inst))) {
                  ...
                  if (isRegIdx(MIR_Compare.getVal2(inst))) {
                    ...
                    if (VM.VerifyAssertions && !isRegInd(MIR_Compare.getVal2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                    if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Compare.getVal1(inst)).isValidAs8bitRegister());
      ...
      if (isImm(MIR_Compare.getVal2(inst))) {
            ...
            if (isRegDisp(MIR_Compare.getVal1(inst))) {
              ...
              if (isRegOff(MIR_Compare.getVal1(inst))) {
                ...
                if (isRegIdx(MIR_Compare.getVal1(inst))) {
                  ...
                  if (VM.VerifyAssertions && !isRegInd(MIR_Compare.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        ...
        if (isByte(inst)) {
          if (isAbs(MIR_Compare.getVal1(inst))) {
            if (VM.VerifyAssertions && !isGPR_Reg(MIR_Compare.getVal2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Compare.getVal2(inst)).isValidAs8bitRegister());
  ...
  private void doMOVSD(Instruction inst) {
    if (isXMM_Reg(MIR_Move.getResult(inst))) {
          ...
          if (isRegDisp(MIR_Move.getValue(inst))) {
            ...
            if (isRegOff(MIR_Move.getValue(inst))) {
              ...
              if (isRegIdx(MIR_Move.getValue(inst))) {
                ...
                if (VM.VerifyAssertions && !isRegInd(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      ...
      if (isAbs(MIR_Move.getResult(inst))) {
        if (VM.VerifyAssertions && !isXMM_Reg(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        emitMOVSD_Abs_Reg(
          getDisp(MIR_Move.getResult(inst)).toWord().toAddress(),
          getXMM_Reg(MIR_Move.getValue(inst)));
  ...
  private void doMETHODSTART(Instruction inst) {
    if (VM.VerifyAssertions && !isGPR_Reg(MIR_Nullary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitMETHODSTART_Reg(
  ...
  private void doBTC(Instruction inst) {
    if (isQuad(inst)) {
      if (isImm(MIR_Test.getVal2(inst))) {
            ...
            if (isRegDisp(MIR_Test.getVal1(inst))) {
              ...
              if (isRegOff(MIR_Test.getVal1(inst))) {
                ...
                if (isRegIdx(MIR_Test.getVal1(inst))) {
                  ...
                  if (VM.VerifyAssertions && !isRegInd(MIR_Test.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                  emitBTC_RegInd_Imm_Quad(
        ...
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_Test.getVal2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          emitBTC_Reg_Reg_Quad(
            getGPR_Reg(MIR_Test.getVal1(inst)),
        ...
        if (isRegDisp(MIR_Nullary.getResult(inst))) {
          ...
          if (isRegOff(MIR_Nullary.getResult(inst))) {
            ...
            if (isRegIdx(MIR_Nullary.getResult(inst))) {
              ...
              if (VM.VerifyAssertions && !isRegInd(MIR_Nullary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              emitPOP_RegInd(
  ...
  private void doFLDLN2(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Nullary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitFLDLN2_Reg(
  ...
  private void doMOVSX(Instruction inst) {
    if (isByte(inst)) {
      ...
      if (isGPR_Reg(MIR_Unary.getVal(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Unary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        if (VM.VerifyAssertions && !isWord(inst)) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doFLD(Instruction inst) {
    if (isQuad(inst)) {
      if (isAbs(MIR_Move.getValue(inst))) {
        if (VM.VerifyAssertions && !isFPR_Reg(MIR_Move.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          ...
          if (isRegDisp(MIR_UnaryNoRes.getVal(inst))) {
            ...
            if (isRegOff(MIR_UnaryNoRes.getVal(inst))) {
              ...
              if (isRegIdx(MIR_UnaryNoRes.getVal(inst))) {
                ...
                if (VM.VerifyAssertions && !isRegInd(MIR_UnaryNoRes.getVal(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                emitPUSH_RegInd(
  ...
  private void doBTS(Instruction inst) {
    if (isQuad(inst)) {
      if (isImm(MIR_Test.getVal2(inst))) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          emitBTS_Reg_Imm_Quad(
            getGPR_Reg(MIR_Test.getVal1(inst)),
            getImm(MIR_Test.getVal2(inst)));

        } else {
          if (isAbs(MIR_Test.getVal1(inst))) {
            emitBTS_Abs_Imm_Quad(
              getDisp(MIR_Test.getVal1(inst)).toWord().toAddress(),
              getImm(MIR_Test.getVal2(inst)));

          } else {
            if (isRegDisp(MIR_Test.getVal1(inst))) {
              emitBTS_RegDisp_Imm_Quad(
                getBase(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                getImm(MIR_Test.getVal2(inst)));

            } else {
              if (isRegOff(MIR_Test.getVal1(inst))) {
                emitBTS_RegOff_Imm_Quad(
                  getIndex(MIR_Test.getVal1(inst)), getScale(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                  getImm(MIR_Test.getVal2(inst)));

              } else {
                if (isRegIdx(MIR_Test.getVal1(inst))) {
                  emitBTS_RegIdx_Imm_Quad(
                    getBase(MIR_Test.getVal1(inst)), getIndex(MIR_Test.getVal1(inst)), getScale(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                    getImm(MIR_Test.getVal2(inst)));

                } else {
                  if (VM.VerifyAssertions && !isRegInd(MIR_Test.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                  emitBTS_RegInd_Imm_Quad(
                    getBase(MIR_Test.getVal1(inst)),
                    getImm(MIR_Test.getVal2(inst)));
                }
              }
  ...
  private void doBTR(Instruction inst) {
    if (isQuad(inst)) {
      if (isImm(MIR_Test.getVal2(inst))) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          emitBTR_Reg_Imm_Quad(
            getGPR_Reg(MIR_Test.getVal1(inst)),
            getImm(MIR_Test.getVal2(inst)));

        } else {
          if (isAbs(MIR_Test.getVal1(inst))) {
            emitBTR_Abs_Imm_Quad(
              getDisp(MIR_Test.getVal1(inst)).toWord().toAddress(),
              getImm(MIR_Test.getVal2(inst)));

          } else {
            if (isRegDisp(MIR_Test.getVal1(inst))) {
              emitBTR_RegDisp_Imm_Quad(
                getBase(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                getImm(MIR_Test.getVal2(inst)));

            } else {
              if (isRegOff(MIR_Test.getVal1(inst))) {
                emitBTR_RegOff_Imm_Quad(
                  getIndex(MIR_Test.getVal1(inst)), getScale(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                  getImm(MIR_Test.getVal2(inst)));

              } else {
                if (isRegIdx(MIR_Test.getVal1(inst))) {
                  emitBTR_RegIdx_Imm_Quad(
                    getBase(MIR_Test.getVal1(inst)), getIndex(MIR_Test.getVal1(inst)), getScale(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                    getImm(MIR_Test.getVal2(inst)));

                } else {
                  if (VM.VerifyAssertions && !isRegInd(MIR_Test.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                  emitBTR_RegInd_Imm_Quad(
                    getBase(MIR_Test.getVal1(inst)),
                    getImm(MIR_Test.getVal2(inst)));
                }
              }
              ...
              if (isRegIdx(MIR_Call.getTarget(inst))) {
                ...
                if (isRegInd(MIR_Call.getTarget(inst))) {
                  ...
                  if (isLabel(MIR_Call.getTarget(inst))) {
                    ...
                    if (VM.VerifyAssertions && !isImmOrLabel(MIR_Call.getTarget(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                    emitCALL_ImmOrLabel(
  ...
  private void doSET(Instruction inst) {
    if (isGPR_Reg(MIR_Set.getResult(inst))) {
      if (VM.VerifyAssertions && !isCond(MIR_Set.getCond(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      if (VM.VerifyAssertions && !isByte(inst)) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Set.getResult(inst)).isValidAs8bitRegister());
        ...
        if (isRegDisp(MIR_Set.getResult(inst))) {
          ...
          if (isRegOff(MIR_Set.getResult(inst))) {
            ...
            if (isRegIdx(MIR_Set.getResult(inst))) {
              ...
              if (VM.VerifyAssertions && !isCond(MIR_Set.getCond(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isRegInd(MIR_Set.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isByte(inst)) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      ...
      if (isImm(MIR_Test.getVal2(inst))) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          ...
          if (isAbs(MIR_Test.getVal1(inst))) {
            ...
            if (isRegDisp(MIR_Test.getVal1(inst))) {
              emitBT_RegDisp_Imm_Quad(
                getBase(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                getImm(MIR_Test.getVal2(inst)));

            } else {
              if (isRegOff(MIR_Test.getVal1(inst))) {
                emitBT_RegOff_Imm_Quad(
                  getIndex(MIR_Test.getVal1(inst)), getScale(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                  getImm(MIR_Test.getVal2(inst)));

              } else {
                if (isRegIdx(MIR_Test.getVal1(inst))) {
                  emitBT_RegIdx_Imm_Quad(
                    getBase(MIR_Test.getVal1(inst)), getIndex(MIR_Test.getVal1(inst)), getScale(MIR_Test.getVal1(inst)), getDisp(MIR_Test.getVal1(inst)),
                    getImm(MIR_Test.getVal2(inst)));

                } else {
                  if (VM.VerifyAssertions && !isRegInd(MIR_Test.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                  emitBT_RegInd_Imm_Quad(
                    getBase(MIR_Test.getVal1(inst)),
                    getImm(MIR_Test.getVal2(inst)));
                }
              }
   ...
   * @param inst the instruction to assemble
   */
  private void doMOVSXDQ(Instruction inst) {
    if (isGPR_Reg(MIR_Unary.getVal(inst))) {
      if (VM.VerifyAssertions && !isGPR_Reg(MIR_Unary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      emitMOVSXDQ_Reg_Reg(
        getGPR_Reg(MIR_Unary.getResult(inst)),
  ...
  private void doOFFSET(Instruction inst) {
    if (VM.VerifyAssertions && !isImm(MIR_CaseLabel.getIndex(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    if (VM.VerifyAssertions && !isImmOrLabel(MIR_CaseLabel.getTarget(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    ...
    if (isQuad(inst)) {
      if (isImm(MIR_DoubleShift.getBitsToShift(inst))) {
        if (isGPR_Reg(MIR_DoubleShift.getResult(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getSource(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            ...
            if (isRegDisp(MIR_DoubleShift.getResult(inst))) {
              ...
              if (isRegOff(MIR_DoubleShift.getResult(inst))) {
                ...
                if (isRegIdx(MIR_DoubleShift.getResult(inst))) {
                  ...
                  if (VM.VerifyAssertions && !isRegInd(MIR_DoubleShift.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                  if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getSource(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        ...
        if (isGPR_Reg(MIR_DoubleShift.getResult(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getSource(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_DoubleShift.getBitsToShift(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doCMPXCHG(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_CompareExchange.getMemAddr(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_CompareExchange.getNewValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          ...
          if (isRegDisp(MIR_CompareExchange.getMemAddr(inst))) {
            ...
            if (isRegOff(MIR_CompareExchange.getMemAddr(inst))) {
              ...
              if (isRegIdx(MIR_CompareExchange.getMemAddr(inst))) {
                ...
                if (VM.VerifyAssertions && !isRegInd(MIR_CompareExchange.getMemAddr(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                if (VM.VerifyAssertions && !isGPR_Reg(MIR_CompareExchange.getNewValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
   ...
   * @param inst the instruction to assemble
   */
  private void doMOVAPD(Instruction inst) {
    if (isXMM_Reg(MIR_Move.getResult(inst))) {
      if (isXMM_Reg(MIR_Move.getValue(inst))) {
        emitMOVAPD_Reg_Reg(
          getXMM_Reg(MIR_Move.getResult(inst)),
        ...
        if (isAbs(MIR_Move.getValue(inst))) {
          ...
          if (isRegDisp(MIR_Move.getValue(inst))) {
            emitMOVAPD_Reg_RegDisp(
              getXMM_Reg(MIR_Move.getResult(inst)),
              getBase(MIR_Move.getValue(inst)), getDisp(MIR_Move.getValue(inst)));

          } else {
            if (isRegOff(MIR_Move.getValue(inst))) {
              emitMOVAPD_Reg_RegOff(
                getXMM_Reg(MIR_Move.getResult(inst)),
                getIndex(MIR_Move.getValue(inst)), getScale(MIR_Move.getValue(inst)), getDisp(MIR_Move.getValue(inst)));

            } else {
              if (isRegIdx(MIR_Move.getValue(inst))) {
                emitMOVAPD_Reg_RegIdx(
                  getXMM_Reg(MIR_Move.getResult(inst)),
                  getBase(MIR_Move.getValue(inst)), getIndex(MIR_Move.getValue(inst)), getScale(MIR_Move.getValue(inst)), getDisp(MIR_Move.getValue(inst)));

              } else {
                if (VM.VerifyAssertions && !isRegInd(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                emitMOVAPD_Reg_RegInd(
                  getXMM_Reg(MIR_Move.getResult(inst)),
                  getBase(MIR_Move.getValue(inst)));
              }
            }
  ...
  private void doDIV(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_Divide.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Divide.getResult2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          ...
          if (isRegDisp(MIR_Divide.getValue(inst))) {
            ...
            if (isRegOff(MIR_Divide.getValue(inst))) {
              ...
              if (isRegIdx(MIR_Divide.getValue(inst))) {
                ...
                if (VM.VerifyAssertions && !isGPR_Reg(MIR_Divide.getResult2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                if (VM.VerifyAssertions && !isRegInd(MIR_Divide.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doNEG(Instruction inst) {
    if (isByte(inst)) {
      if (isGPR_Reg(MIR_UnaryAcc.getResult(inst))) {
        if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_UnaryAcc.getResult(inst)).isValidAs8bitRegister());
        emitNEG_Reg_Byte(
          getGPR_Reg(MIR_UnaryAcc.getResult(inst)));
          ...
          if (isRegDisp(MIR_UnaryAcc.getResult(inst))) {
            ...
            if (isRegOff(MIR_UnaryAcc.getResult(inst))) {
              ...
              if (isRegIdx(MIR_UnaryAcc.getResult(inst))) {
                ...
                if (VM.VerifyAssertions && !isRegInd(MIR_UnaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                emitNEG_RegInd_Byte(
   ...
   * @param inst the instruction to assemble
   */
  private void doMOVAPS(Instruction inst) {
    if (isXMM_Reg(MIR_Move.getResult(inst))) {
      if (isXMM_Reg(MIR_Move.getValue(inst))) {
        emitMOVAPS_Reg_Reg(
          getXMM_Reg(MIR_Move.getResult(inst)),
        ...
        if (isAbs(MIR_Move.getValue(inst))) {
          ...
          if (isRegDisp(MIR_Move.getValue(inst))) {
            emitMOVAPS_Reg_RegDisp(
              getXMM_Reg(MIR_Move.getResult(inst)),
              getBase(MIR_Move.getValue(inst)), getDisp(MIR_Move.getValue(inst)));

          } else {
            if (isRegOff(MIR_Move.getValue(inst))) {
              emitMOVAPS_Reg_RegOff(
                getXMM_Reg(MIR_Move.getResult(inst)),
                getIndex(MIR_Move.getValue(inst)), getScale(MIR_Move.getValue(inst)), getDisp(MIR_Move.getValue(inst)));

            } else {
              if (isRegIdx(MIR_Move.getValue(inst))) {
                emitMOVAPS_Reg_RegIdx(
                  getXMM_Reg(MIR_Move.getResult(inst)),
                  getBase(MIR_Move.getValue(inst)), getIndex(MIR_Move.getValue(inst)), getScale(MIR_Move.getValue(inst)), getDisp(MIR_Move.getValue(inst)));

              } else {
                if (VM.VerifyAssertions && !isRegInd(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                emitMOVAPS_Reg_RegInd(
                  getXMM_Reg(MIR_Move.getResult(inst)),
                  getBase(MIR_Move.getValue(inst)));
              }
            }
  ...
  private void doFSUBP(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_BinaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_BinaryAcc.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitFSUBP_Reg_Reg(
      getFPR_Reg(MIR_BinaryAcc.getResult(inst)),
      getFPR_Reg(MIR_BinaryAcc.getValue(inst)));
  }
   ...
   *  Emit the given instruction, assuming that
   * it is a MIR_Empty instruction
   * and has a UD2 operator
   *
   * @param inst the instruction to assemble
   */
  private void doUD2(Instruction inst) {
    emitUD2();
  }
  ...
  private void doFXCH(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_XChng.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_XChng.getVal2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitFXCH_Reg_Reg(
      ...
      if (isRegDisp(MIR_FSave.getDestination(inst))) {
        ...
        if (isRegOff(MIR_FSave.getDestination(inst))) {
          ...
          if (isRegIdx(MIR_FSave.getDestination(inst))) {
            ...
            if (VM.VerifyAssertions && !isRegInd(MIR_FSave.getDestination(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            emitFNSAVE_RegInd(
  ...
  private void doMUL(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_Multiply.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Multiply.getResult2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          ...
          if (isRegDisp(MIR_Multiply.getValue(inst))) {
            ...
            if (isRegOff(MIR_Multiply.getValue(inst))) {
              ...
              if (isRegIdx(MIR_Multiply.getValue(inst))) {
                ...
                if (VM.VerifyAssertions && !isGPR_Reg(MIR_Multiply.getResult2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                if (VM.VerifyAssertions && !isRegInd(MIR_Multiply.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
   ...
   * @param inst the instruction to assemble
   */
  private void doFFREEP(Instruction inst) {
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_Nullary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitFFREEP_Reg(
      getFPR_Reg(MIR_Nullary.getResult(inst)));
  }
  ...
  private void doUCOMISD(Instruction inst) {
    if (isXMM_Reg(MIR_Compare.getVal2(inst))) {
      if (VM.VerifyAssertions && !isXMM_Reg(MIR_Compare.getVal1(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
      emitUCOMISD_Reg_Reg(
  ...
  private void doTEST(Instruction inst) {
    if (isImm(MIR_Test.getVal2(inst))) {
      if (isByte(inst)) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Test.getVal1(inst)).isValidAs8bitRegister());
      ...
      if (isByte(inst)) {
        if (isGPR_Reg(MIR_Test.getVal1(inst))) {
          if (VM.VerifyAssertions && !isGPR_Reg(MIR_Test.getVal2(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
          if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Test.getVal1(inst)).isValidAs8bitRegister());
          if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Test.getVal2(inst)).isValidAs8bitRegister());
  ...
  private void doCMPXCHG8B(Instruction inst) {
    if (isAbs(MIR_CompareExchange8B.getMemAddr(inst))) {
      emitCMPXCHG8B_Abs(
        getDisp(MIR_CompareExchange8B.getMemAddr(inst)).toWord().toAddress());
      ...
      if (isRegDisp(MIR_CompareExchange8B.getMemAddr(inst))) {
        ...
        if (isRegOff(MIR_CompareExchange8B.getMemAddr(inst))) {
          ...
          if (isRegIdx(MIR_CompareExchange8B.getMemAddr(inst))) {
            ...
            if (VM.VerifyAssertions && !isRegInd(MIR_CompareExchange8B.getMemAddr(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
   ...
   * @param inst the instruction to assemble
   */
  private void doFSTSW(Instruction inst) {
    if (isGPR_Reg(MIR_Unary.getResult(inst))) {
      emitFSTSW_Reg(
        getGPR_Reg(MIR_Unary.getResult(inst)));

    } else {
      if (isAbs(MIR_Unary.getResult(inst))) {
        emitFSTSW_Abs(
          getDisp(MIR_Unary.getResult(inst)).toWord().toAddress());

      } else {
        if (isRegDisp(MIR_Unary.getResult(inst))) {
          emitFSTSW_RegDisp(
            getBase(MIR_Unary.getResult(inst)), getDisp(MIR_Unary.getResult(inst)));

        } else {
          if (isRegOff(MIR_Unary.getResult(inst))) {
            emitFSTSW_RegOff(
              getIndex(MIR_Unary.getResult(inst)), getScale(MIR_Unary.getResult(inst)), getDisp(MIR_Unary.getResult(inst)));

          } else {
            if (isRegIdx(MIR_Unary.getResult(inst))) {
              emitFSTSW_RegIdx(
                getBase(MIR_Unary.getResult(inst)), getIndex(MIR_Unary.getResult(inst)), getScale(MIR_Unary.getResult(inst)), getDisp(MIR_Unary.getResult(inst)));

            } else {
              if (VM.VerifyAssertions && !isRegInd(MIR_Unary.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              emitFSTSW_RegInd(
                getBase(MIR_Unary.getResult(inst)));
            }
          }
        }
      }
  ...
  private void doCMOV(Instruction inst) {
    if (isQuad(inst)) {
      if (isGPR_Reg(MIR_CondMove.getValue(inst))) {
        if (VM.VerifyAssertions && !isCond(MIR_CondMove.getCond(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_CondMove.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        emitCMOV_Cond_Reg_Reg_Quad(
        ...
        if (isAbs(MIR_CondMove.getValue(inst))) {
          ...
          if (isRegDisp(MIR_CondMove.getValue(inst))) {
            if (VM.VerifyAssertions && !isCond(MIR_CondMove.getCond(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            if (VM.VerifyAssertions && !isGPR_Reg(MIR_CondMove.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            emitCMOV_Cond_Reg_RegDisp_Quad(
              getCond(MIR_CondMove.getCond(inst)),
              getGPR_Reg(MIR_CondMove.getResult(inst)),
            ...
            if (isRegOff(MIR_CondMove.getValue(inst))) {
              ...
              if (isRegIdx(MIR_CondMove.getValue(inst))) {
                ...
                if (VM.VerifyAssertions && !isCond(MIR_CondMove.getCond(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                if (VM.VerifyAssertions && !isGPR_Reg(MIR_CondMove.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                if (VM.VerifyAssertions && !isRegInd(MIR_CondMove.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
                emitCMOV_Cond_Reg_RegInd_Quad(
                  getCond(MIR_CondMove.getCond(inst)),
                  getGPR_Reg(MIR_CondMove.getResult(inst)),
  ...
  private void doINT(Instruction inst) {
    if (VM.VerifyAssertions && !isImm(MIR_Trap.getTrapCode(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitINT_Imm(
  ...
  private void doPREFETCHNTA(Instruction inst) {
    if (VM.VerifyAssertions && !isGPR_Reg(MIR_CacheOp.getAddress(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    emitPREFETCHNTA_Reg(
  ...
  private void doLEA(Instruction inst) {
    if (isQuad(inst)) {
      if (isAbs(MIR_Lea.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_Lea.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
        ...
        if (isRegDisp(MIR_Lea.getValue(inst))) {
          ...
          if (isRegOff(MIR_Lea.getValue(inst))) {
            ...
            if (isRegIdx(MIR_Lea.getValue(inst))) {
              ...
              if (VM.VerifyAssertions && !isGPR_Reg(MIR_Lea.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
              if (VM.VerifyAssertions && !isRegInd(MIR_Lea.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doFCMOV(Instruction inst) {
    if (VM.VerifyAssertions && !isCond(MIR_CondMove.getCond(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_CondMove.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
    if (VM.VerifyAssertions && !isFPR_Reg(MIR_CondMove.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  private void doMOV(Instruction inst) {
    if (isGPR_Reg(MIR_Move.getResult(inst))) {
      if (isQuad(inst)) {
        ...
        if (isByte(inst)) {
          if (isGPR_Reg(MIR_Move.getValue(inst))) {
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Move.getResult(inst)).isValidAs8bitRegister());
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Move.getValue(inst)).isValidAs8bitRegister());
      ...
      if (isImm(MIR_Move.getValue(inst))) {
        ...
        if (isByte(inst)) {
          if (isAbs(MIR_Move.getResult(inst))) {
            if (VM.VerifyAssertions && !isGPR_Reg(MIR_Move.getValue(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
            if (VM.VerifyAssertions) opt_assert(getGPR_Reg(MIR_Move.getValue(inst)).isValidAs8bitRegister());
  ...
  private void doIMUL2(Instruction inst) {
    if (isQuad(inst)) {
      if (isImm(MIR_BinaryAcc.getValue(inst))) {
        if (VM.VerifyAssertions && !isGPR_Reg(MIR_BinaryAcc.getResult(inst))) throw new OptimizingCompilerException("Unexpected operand " + inst.toString());
  ...
  public void doInst(Instruction inst) {
    ...
    switch (inst.getOpcode()) {
      ...
      case MIR_LOWTABLESWITCH_opcode:
        ...
        break;
      // Make machine code dumps more readable by visually
      // distinguishing basic blocks
      case LABEL_opcode:
        comment("");
        comment(Label.getBlock(inst).toString());
        break;
      // Opcodes that are not allowed to be present. Those are expected
      // to be handled earlier.
      case IA32_LOCK_CMPXCHG_opcode:
      case IA32_FMOV_ENDING_LIVE_RANGE_opcode:
      case IA32_JCC2_opcode:
      case IA32_FEXAM_opcode:
      case IA32_FNSTSW_opcode:
    ...
    mcOffsets.setMachineCodeOffset(inst, mi);
  }
